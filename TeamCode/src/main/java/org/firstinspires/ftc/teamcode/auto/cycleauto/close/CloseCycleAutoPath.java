...
public abstract class CloseCycleAutoPath extends CloseCycleAuto {
    ...
    static {
        SHOOT_X = 27.631; SHOOT_Y = 40.047; SHOOT_H = -0.74;

        INTAKE_1_X = 53.142; INTAKE_1_Y = 27.694; INTAKE_1_H = -Math.PI/2;
        INTAKE_FORWARD_1_X = 54.370; INTAKE_FORWARD_1_Y = 12; INTAKE_FORWARD_1_H = -Math.PI/2;

        INTAKE_GATE_X = 51; INTAKE_GATE_Y = -3; INTAKE_GATE_H = -1.9;
        INTAKE_GATE_FORWARD_X = 57; INTAKE_GATE_FORWARD_Y = -6; INTAKE_GATE_FORWARD_H = -2.3;

        INTAKE_2_X = 74; INTAKE_2_Y = 31; INTAKE_2_H = -Math.PI/2;
        INTAKE_FORWARD_2_X = 77; INTAKE_FORWARD_2_Y = 10; INTAKE_FORWARD_2_H = -Math.PI/2;
